...
export default function EpisodesSocialJustice() {
    ...
    const {
        ...
        loadMorePodcasts
    } = useFetchPodcasts('isSocialJustice');
    ...
    return (
        <div className="ep-wrapper">
            <div className="ep-pillar-block1 sj-background">
                <h1 className="ep-pillar-block1-title">SOCIAL JUSTICE</h1>
                <div className="ep-pillar-block1-blurb1">
                    <h2 className="ep-pillar-block1-subtitle">Welcome to our Social Justice pillar</h2>
                    <p className="ep-pillar-block1-text">
                        Social justice is about more than hashtags — it's about understanding systems, privilege, and the fight 
                        for a fairer world. In this pillar, we explore tough but necessary conversations around race, gender, 
                        inequality, and activism. This is a space where we can learn, reflect, and challenge ourselves to be better 
                        humans together. It's about progress over perfection, and knowing we all have a role to play when creating 
                        a better society.
                    </p>
                </div>
                <div className="ep-pillar-block1-blurb2">
                    <p className="ep-pillar-block1-quote">
                        "In trying to make a big difference, don't ignore the small daily differences 
                        we can make."
                    </p>
                    <p className="ep-pillar-block1-text-light">Marian Wright Edelman</p>
                </div>
            </div>
