...
export default function EpisodesMentalHealth() {
    ...
    const {
        ...
        loadMorePodcasts
    } = useFetchPodcasts('isMentalHealth');
    ...
    return (
        <div className="ep-wrapper">
            <div className="ep-pillar-block1 mh-background">
                <h1 className="ep-pillar-block1-title">MENTAL HEALTH</h1>
                <div className="ep-pillar-block1-blurb1">
                    <h2 className="ep-pillar-block1-subtitle">Welcome to our Mental Health pillar</h2>
                    <p className="ep-pillar-block1-text">
                        A space where we openly explore mental well-being with honesty and care. While Naomi is not a mental health 
                        professional, she is here to share stories, insights, and practical tips based on personal experience and 
                        research. This is a judgment-free zone to help you understand more about yourself. Whether youre looking for 
                        support or just want to learn, this space is about self awareness, connection, and finding strength together.
                    </p>
                </div>
                <div className="ep-pillar-block1-blurb2">
                    <p className="ep-pillar-block1-quote">
                        "Anything that's human is mentionable, and anything that is mentionable can be more manageable. When we can 
                        talk about our feelings, they become less overwhelming, less upsetting, and less scary."
                    </p>
                    <p className="ep-pillar-block1-text-light">Fred Rogers</p>
                </div>
            </div>
